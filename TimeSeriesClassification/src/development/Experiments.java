...
//        foldsInFile=true;
    ...
    //Args 1 and 2 are problem and results path
                ...
                newArgs[0]="//cmptscsvr.cmp.uea.ac.uk/ueatsc/Data/ConcatenatedMTSC/";//All on the beast now
                newArgs[1]="//cmptscsvr.cmp.uea.ac.uk/ueatsc/Results/ConcatenatedMTSC/";
    //Arg 3 argument is whether to cross validate or not and produce train files
                newArgs[2]="false";
    // Arg 4,5,6 Classifier, Problem, Fold  
                String[] names={"XGBoost"};
...
//                String[] problems=DataSets.tscProblems85;
                    String[] problems=new String[]{"FaceDetection","FingerMovements",
"HandMovementDirection","MotorImagery","SelfRegulationSCP1","SelfRegulationSCP2"};
